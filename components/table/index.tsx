...
import { Order, EnhancedTableProps } from './table.d';
...
export default function EnhancedTable(props: EnhancedTableProps) {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      ...
      <Paper elevation={2} sx={{ borderRadius: '.5rem',boxShadow: 'none' ,border: '1px solid #e0e0e0' }} >
        ...
        {pagination && (
          ...
          >
            <Item sx={{ flexGrow: 1, pl: '1rem' }}>
              <Typography variant="body2">{rows.length} entries found</Typography>
            </Item>
            <Item>
