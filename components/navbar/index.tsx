          ...
          <ListItemButton onClick={() => setActive('user')}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: "100%" }}>
              <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontSize: '0.875rem' }}>User Management</Typography>
              </Box>
              <Typography sx={{ color: '#21328d', fontSize: '1.5rem', }}> <i className="ri-arrow-right-s-line"></i></Typography>
            </Box>
          </ListItemButton>
          ...
          <ListItemButton onClick={() => setActive('driver')}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: "100%" }}>
              <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontSize: '0.875rem' }}>Driver Management</Typography>
              </Box>
              <Typography sx={{ color: '#21328d', fontSize: '1.5rem', }}> <i className="ri-arrow-right-s-line"></i></Typography>
            </Box>
          </ListItemButton>
          ...
          <ListItemButton onClick={() => setActive('ride')}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: "100%" }}>
              <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontSize: '0.875rem' }}>Ride Management</Typography>
              </Box>
              <Typography sx={{ color: '#21328d', fontSize: '1.5rem', }}> <i className="ri-arrow-right-s-line"></i></Typography>
            </Box>
          </ListItemButton>
          ...
          <ListItemButton onClick={() => setActive('payments')}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: "100%" }}>
              <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontSize: '0.875rem' }}>Payments</Typography>
              </Box>
              <Typography sx={{ color: '#21328d', fontSize: '1.5rem', }}><i className="ri-arrow-right-s-line"></i></Typography>
            </Box>
          </ListItemButton>
          ...
          <ListItemButton onClick={() => setActive('notifications')}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: "100%" }}>
              <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontSize: '0.875rem' }}>Notifications</Typography>
              </Box>
              <Typography sx={{ color: '#21328d', fontSize: '1.5rem', }}><i className="ri-arrow-right-s-line"></i></Typography>
            </Box>
          </ListItemButton>
          ...
          <ListItemButton onClick={() => setActive('marketing')}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: "100%" }}>
              <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontSize: '0.875rem' }}>Promotions & Marketing</Typography>
              </Box>
              <Typography sx={{ color: '#21328d', fontSize: '1.5rem', }}><i className="ri-arrow-right-s-line"></i></Typography>
            </Box>
          </ListItemButton>
          ...
          <ListItemButton onClick={() => setActive('support')}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: "100%" }}>
              <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontSize: '0.875rem' }}>Customer Support</Typography>
              </Box>
              <Typography sx={{ color: '#21328d', fontSize: '1.5rem', }}><i className="ri-arrow-right-s-line"></i></Typography>
            </Box>
          </ListItemButton>
          ...
          <ListItemButton onClick={() => setActive('feedback')}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: "100%" }}>
              <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontSize: '0.875rem' }}>Feedback</Typography>
              </Box>
              <Typography sx={{ color: '#21328d', fontSize: '1.5rem', }}> <i className="ri-arrow-right-s-line"></i></Typography>
            </Box>
          </ListItemButton>
